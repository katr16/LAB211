...
public class WorkerData {
    ...
    private static WorkerData instance = null;
    private Validation valid = new Validation();

    public static WorkerData Instance() {
        if (instance == null) {
            synchronized (WorkerData.class) {
                if (instance == null) {
                    instance = new WorkerData();
                }
            }
        }
        return instance;
    ...
    public boolean changeSalary(List<Worker> workers, int location, int type) {
        double change = valid.inputDouble("Enter salary increased");
